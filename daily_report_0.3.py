...
# VARIABLES
DESKTOP_A = r'DESKTOP-22NRLQJ\SQLEXPRESS'
DESKTOP_B = r"DESKTOP-N6R5QHN\SQLEXPRESS"
DESKTOP_C = r"VAVILOV\SQLEXPRESS"
DESKTOP_D = r'localhost\SQLEXPRESS01'

DESKTOP_C_DB = 'GES_SCADA_4_IOServer'
DEFAULT_DB = 'GES_SCADA_IOServer'
